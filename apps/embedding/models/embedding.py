...
from dataset.models.data_set import Document, Paragraph, DataSet, Chunk
...
class Embedding(models.Model):
    ...
    chunk = models.ForeignKey(Chunk, on_delete=models.DO_NOTHING, verbose_name="分块关联", db_constraint=False, null=True, blank=True)
