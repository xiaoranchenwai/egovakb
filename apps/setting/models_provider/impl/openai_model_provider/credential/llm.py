...
class OpenAILLMModelCredential(BaseForm, BaseModelCredential):
    ...
    def is_valid(self, model_type: str, model_name, model_credential: Dict[str, object], model_params, provider,
                 raise_exception=False, model_headers: Dict[str, object] = None):
        ...
        try:
            ...
            model = provider.get_model_v2(model_type, model_name, model_credential, model_headers=model_headers, **model_params)
