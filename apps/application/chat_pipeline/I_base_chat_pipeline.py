...
class ParagraphPipelineModel:
    ...
    def __init__(self, _id: str, document_id: str, dataset_id: str, content: str, title: str, status: str,
                 ...
                 hit_handling_method: str, directly_return_similarity: float, meta: dict = None, chunk_id: str = None,
                 chunk_data: str = None):
        self.id = _id
    ...
    class builder:
        ...
        def add_chunk_data(self, chunk_data: str):
            self.chunk_data = chunk_data
            return self
        ...
        def build(self):
            return ParagraphPipelineModel(str(self.paragraph.get('id')), str(self.paragraph.get('document_id')),
                                          ...
                                          self.meta, self.chunk_id, self.chunk_data)
