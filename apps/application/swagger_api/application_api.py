    ...
    class Setting:
        ...
        def get_response_body_api():
            return openapi.Schema(
                type=openapi.TYPE_OBJECT,
                properties={
                    'show_history': openapi.Schema(type=openapi.TYPE_BOOLEAN),
                    'draggable': openapi.Schema(type=openapi.TYPE_BOOLEAN),
                    'show_guide': openapi.Schema(type=openapi.TYPE_BOOLEAN),
                    'avatar': openapi.Schema(type=openapi.TYPE_STRING),
                    'avatar_url': openapi.Schema(type=openapi.TYPE_STRING),
                    'float_icon': openapi.Schema(type=openapi.TYPE_STRING),
                    'float_icon_url': openapi.Schema(type=openapi.TYPE_STRING),
                    'user_avatar': openapi.Schema(type=openapi.TYPE_STRING),
                    'user_avatar_url': openapi.Schema(type=openapi.TYPE_STRING),
                    'disclaimer': openapi.Schema(type=openapi.TYPE_BOOLEAN),
                    'disclaimer_value': openapi.Schema(type=openapi.TYPE_STRING),
                    'custom_theme': openapi.Schema(type=openapi.TYPE_OBJECT),
                    'float_location': openapi.Schema(type=openapi.TYPE_OBJECT)
                }
            )
        ...
        def get_request_body_api():
            return openapi.Schema(
                ...
                properties={
                    ...
                    'float_icon': openapi.Schema(type=openapi.TYPE_FILE),
                    'user_avatar': openapi.Schema(type=openapi.TYPE_FILE),
                    'disclaimer': openapi.Schema(type=openapi.TYPE_BOOLEAN),
                    'disclaimer_value': openapi.Schema(type=openapi.TYPE_STRING),
                    'custom_theme': openapi.Schema(type=openapi.TYPE_OBJECT),
                    'float_location': openapi.Schema(type=openapi.TYPE_OBJECT)
