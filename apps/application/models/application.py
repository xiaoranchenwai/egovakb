...
class ApplicationApiKey(AppModelMixin):
    ...
    cross_domain_list = ArrayField(verbose_name="跨域列表",
                                   ...
                                   , default=list)
    name = models.CharField(max_length=128, verbose_name="名称", default="")
...
class Chat(AppModelMixin):
    ...
    api_key = models.ForeignKey(ApplicationApiKey, on_delete=models.SET_NULL, db_constraint=False, blank=True, null=True)
