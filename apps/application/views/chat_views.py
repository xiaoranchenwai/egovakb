    ...
    class Open(APIView):
        ...
        def get(self, request: Request, application_id: str):
            ...
            return result.success(ChatSerializers.OpenChat(
                data={'user_id': request.user.id, 'application_id': application_id, 'api_key': api_key}).open())
    ...
    class Message(APIView):
        ...
        def post(self, request: Request, chat_id: str):
            return ChatMessageSerializer(data={'chat_id': chat_id, 'message': request.data.get('message'),
                                               ...
                                               'thinking': request.data.get('thinking', False) if 'thinking' in request.data else None,
