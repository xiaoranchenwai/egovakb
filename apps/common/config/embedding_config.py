...
class ModelManage:
    ...
    @staticmethod
    def validate_model_headers(model_instance):
        if hasattr(model_instance, 'model_kwargs'):
            if model_instance.model_kwargs is not None:
                if model_instance.model_kwargs.get('model_headers') is not None:
                    if model_instance.model_kwargs.get('model_headers') == {}:
                        del model_instance.model_kwargs['model_headers']
    ...
    def get_model(_id, get_model):
        ...
        try:
            ...
            if model_instance is None or not model_instance.is_cache_model():
                ...
                ModelManage.validate_model_headers(model_instance)
