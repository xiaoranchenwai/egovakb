...
urlpatterns = [
    ...
    # 将静态导入路径放在动态 <dataset_id> 之前，避免被错误匹配
    path('dataset/import', views.Dataset.ImportNew.as_view(), name="import_new"),
    ...
    path('dataset/<str:dataset_id>/import', views.Dataset.Import.as_view(), name="import"),
    ...
    # Chunk paths
    path('dataset/<str:dataset_id>/document/<str:document_id>/paragraph/<str:paragraph_id>/chunk', 
         views.Chunk.as_view()),
    path('dataset/<str:dataset_id>/document/<str:document_id>/paragraph/<str:paragraph_id>/chunk/_batch', 
         views.Chunk.Batch.as_view()),
    path('dataset/<str:dataset_id>/document/<str:document_id>/chunk/<int:current_page>/<int:page_size>', 
         views.Chunk.Page.as_view(), name='chunk_page'),
    path('dataset/<str:dataset_id>/document/<str:document_id>/chunk/<str:chunk_id>', 
         views.Chunk.Operate.as_view()),
    path('paragraph/<str:paragraph_id>/chunk/list', 
         views.Chunk.List.as_view()),
]
