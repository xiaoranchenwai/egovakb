...
from . import views
from .views.user_setting import UserSettingView
...
urlpatterns = [
    ...
    path('user/settings', UserSettingView.as_view(), name='user_settings'),
    path('user/settings/<str:id>', UserSettingView.as_view(), name='user_setting_detail'),
    # MCP回调授权接口
    path('callback/auth', Callback.as_view(), name='callback_auth'),
]
