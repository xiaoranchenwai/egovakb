<template>
  ...
  >
    ...
    >
      ...
      <el-form-item v-if="!isImport" label-width="12em">
        <template #label>
        ...
        <el-radio-group v-model="form.hit_handling_method" class="radio-block mt-4 flex flex-betwwen">
          <template v-for="(value, key) of hitHandlingMethod" :key="key">
            <el-radio :value="key" class="radio">{{ $t(value) }} </el-radio>
          </template>
        </el-radio-group>
      </el-form-item>
      <el-form-item
