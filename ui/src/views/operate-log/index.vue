<template>
  <LayoutContainer class='operate-log-page h-full'>
      ...
      <div class="flex-between">
        ...
        <div style="display: flex">
          <div class="flex-between">
            ...
            <el-button @click="getList" style="margin-left: 10px;border: none;border-left: 1px solid #CED4E0; display: none">
              {{ $t('common.search') }}
            </el-button>
          </div>
...
.operate-log-page {
  ...
  >.el-scrollbar {
    ...
    .el-scrollbar__view ,.content-container__main{
      height: 100%;
      >.p-20 {
        box-sizing: border-box;
      }
