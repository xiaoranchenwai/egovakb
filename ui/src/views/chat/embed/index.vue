  ...
  >
    <div class="chat-embed__header" :style="customStyle">
      <div class="flex align-center">
        ...
        <!-- <h4 style='color: var(--app-header-text-color)'>{{ applicationDetail?.name }}</h4> -->
      </div>
    </div>
    <div>
      ...
      >
        <AppIcon
          ...
          :style="{
            color: '#FFF'||applicationDetail?.custom_theme?.header_font_color
          }"
        ></AppIcon>
      </div>
...
const customStyle = computed(() => {
  console.log('applicationDetail', applicationDetail.value, applicationDetail.value?.custom_theme)
  return {
