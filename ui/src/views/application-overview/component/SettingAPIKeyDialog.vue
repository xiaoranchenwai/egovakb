<template>
  ...
  >
    <el-form label-position="top" label-width="10em" ref="settingFormRef" :model="form">
      ...
      <el-form-item
        ...
        @click.prevent
      >
        <el-switch  v-model="form.allow_cross_domain" inline-prompt
                    :active-text="$t('views.applicationOverview.appInfo.openText')"
                    :inactive-text="$t('views.applicationOverview.appInfo.closeText')"></el-switch>
      </el-form-item>
      <el-form-item>
        <el-input
