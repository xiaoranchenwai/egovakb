              ...
              <div class="flex align-center">
                <div class="mr-12 ml-24 flex">
                  <div class="edit-avatar mr-12" @mouseenter="showEditIcon = true" @mouseleave="showEditIcon = false">
                    <AppAvatar class="setting-avatar-app" v-if="isAppIcon(detail?.icon)" shape="square" :size="32" style="background: none">
                      <img :src="detail?.icon" alt="" />
                    </AppAvatar>
                    <AppAvatar class="setting-avatar-name" v-else-if="detail?.name" :name="detail?.name" pinyinColor shape="square" :size="32" />
                    <AppAvatar v-if="showEditIcon" class="edit-mask setting-avatar-edit" shape="square" :size="32" @click="openEditAvatar">
                      <el-icon>
                        <EditPen />
                      </el-icon>
                    </AppAvatar>
        ...
        <el-card shadow="never" class="mb-8">
          ...
          <div class="border-t mt-8">
            ...
            <el-row :gutter="8" class="w-full mb-8">
              <el-col :span="12">
                <div class="flex align-center">
                  <el-select v-model="xpackForm.float_location.x.type" style="width: 80px;margin-right:8px">
                    <el-option
                      :label="
                        $t(
              ...
              <el-col :span="12">
                <div class="flex align-center">
                  <el-select v-model="xpackForm.float_location.y.type" style="width: 80px;margin-right: 8px">
                    <el-option
                      :label="
                        $t(
...
const open = (data: any, content: any) => {
  ...
  console.log('custom_theme', data.custom_theme, data.custom_theme?.theme_color , data.custom_theme?.header_font_color , xpackForm.value.custom_theme)
  if (data.float_location) {
    if (data.float_location?.x)
    {
