          ...
          <div class="code layout-bg border-t p-8">
            <div class="flex-between p-8">
              ...
              <el-button text @click="copyClick(source1)">
                <AppIcon class="copy" title="复制"></AppIcon>
              </el-button>
            </div>
...
.embed-dialog {
  ...
  :deep(.el-button) {
    --app-text-color-light-1: #F5F7FA !important;
  }
...
.embed-dialog {
  .el-dialog__body {
    padding: var(--el-dialog-padding-primary) var(--el-dialog-padding-primary) !important;
    .code {
