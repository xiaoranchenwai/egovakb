<template>
  <el-dialog
    ...
    width="650"
  >
    <el-form label-position="left" label-width="11em" ref="limitFormRef" :model="form">
      <!-- <el-form-item
      ...
      >
        <el-switch v-model="form.authentication" @change="firstGeneration" active-text="是" inactive-text="否" inline-prompt style="width:48px"></el-switch>
      </el-form-item>
      <el-form-item
      ...
      <el-form-item
        ...
        @click.prevent
      >
        <el-switch v-model="form.white_active" active-text="是" inactive-text="否" inline-prompt ></el-switch>
      </el-form-item>
      <el-form-item>
        <el-input
