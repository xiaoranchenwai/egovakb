  ...
  <el-drawer v-model="visible" size="60%" :before-close="close">
    ...
    <div>
      ...
      >
        ...
        <el-form-item :label="$t('views.functionLib.functionForm.form.functionDescription.label')+':'" class="required-dot">
          <el-input
            v-model="form.desc"
            type="textarea"
        ...
        <el-form-item prop="permission_type">
          ...
          <el-radio-group v-model="form.permission_type" class="card__radio">
            <el-row :gutter="16">
              <template v-for="(value, key) of PermissionType">
                <el-col :span="12">
                  <el-card
                    :key="key"
                    shadow="never"
    ...
    <template #footer>
      <div>
        ...
        <el-button type="primary" @click="submit(FormRef)" :loading="loading">
          {{ isEdit ? $t('common.save') : $t('common.save') }}</el-button
        >
      </div>
    </template>
