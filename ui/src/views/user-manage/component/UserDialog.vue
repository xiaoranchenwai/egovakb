<template>
  ...
  >
    ...
    >
      ...
      <el-form-item :label="$t('views.user.userForm.form.nick_name.label')+':'"  class='required-dot'>
        <el-input
      ...
      <el-form-item :label="$t('views.user.userForm.form.phone.label')+':'"  class='required-dot'>
        <el-input
