  ...
  nodes: {
    ...
    searchDatasetNode: {
      ...
      searchQuestion: {
        ...
        showHitBlock: '只展示命中分块'
      }
    },
    searchKnowledgeBaseNode: {
      label: '知识库子系统检索',
      text: '关联知识库子系统，查找与问题相关的分段',
      paragraph_list: '检索结果的分段列表',
      is_hit_handling_method_list: '满足直接回答的分段列表',
      result: '检索结果',
      directly_return: '满足直接回答的分段内容',
      searchParam: '检索参数',
      searchParamSetting: '搜索参数设置',
      url: '知识库子系统服务地址',
      urlRequired: '请输入知识库子系统服务地址',
      urlPlaceholder: '请输入第三方知识库HTTP接口地址',
      key: 'API密钥',
      keyRequired: '请输入API密钥',
      keyPlaceholder: '请输入访问知识库的API密钥',
      knowledgeBaseList: '知识库列表',
      knowledgeBaseSelectPlaceholder: '请选择知识库',
      searchMode: '检索模式',
      topN: '返回条数',
      similarity: '相似度阈值',
      knowledgeBaseUrl: '外部知识库服务地址',
      knowledgeBaseKey: 'API密钥',
      refreshKnowledgeBase: '刷新知识库列表',
      searchQuestion: {
        label: '检索问题',
        placeholder: '请选择检索问题',
        requiredMessage: '请选择检索问题',
