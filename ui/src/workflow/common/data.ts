 ...
 * 知识库子系统检索配置数据
 */
export const searchKnowledgeBaseNode = {
  type: WorkflowType.SearchKnowledgeBaseNode,
  text: t('views.applicationWorkflow.nodes.searchKnowledgeBaseNode.text'),
  label: t('views.applicationWorkflow.nodes.searchKnowledgeBaseNode.label'),
  height: 355,
  properties: {
    stepName: t('views.applicationWorkflow.nodes.searchKnowledgeBaseNode.label'),
    config: {
      fields: [
        {
          label: t('views.applicationWorkflow.nodes.searchKnowledgeBaseNode.paragraph_list'),
          value: 'paragraph_list'
        },
        {
          label: t('views.applicationWorkflow.nodes.searchKnowledgeBaseNode.is_hit_handling_method_list'),
          value: 'is_hit_handling_method_list'
        },
        {
          label: t('views.applicationWorkflow.nodes.searchKnowledgeBaseNode.result'),
          value: 'data'
        },
        {
          label: t('views.applicationWorkflow.nodes.searchKnowledgeBaseNode.directly_return'),
          value: 'directly_return'
        }
      ]
    }
...
export const nodeDict: any = {
  ...
  [WorkflowType.SearchKnowledgeBaseNode]: searchKnowledgeBaseNode,
