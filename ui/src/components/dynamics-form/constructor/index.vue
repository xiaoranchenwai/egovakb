<template>
  ...
  >
    ...
    <el-form-item :label="$t('dynamicsForm.paramForm.tooltip.label')+':'" class="required-dot">
      <el-input
    ...
    <el-form-item :label="$t('dynamicsForm.paramForm.required.label')+':'" :required="true" prop="required" :rules="rules.required">
      <el-switch v-model="form_data.required" :active-value="true" :inactive-value="false" active-text="是" inactive-text="否" inline-prompt/>
    </el-form-item>
