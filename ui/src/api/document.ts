...
import { get, post, del, put, exportExcel, exportFile, postWithProgress } from '@/request/index'
 ...
 */
const postSplitDocument: (data: any, onProgress?: (percentage: number) => void) => Promise<Result<any>> = (data, onProgress) => {
  return postWithProgress(`${prefix}/document/split`, data, undefined, onProgress, undefined, 1000 * 60 * 60)
}
...
) => Promise<Result<any>> = (dataset_id, data, loading, onProgress) => {
  return postWithProgress(`${prefix}/${dataset_id}/document/qa`, data, undefined, onProgress, loading)
}
...
const postTableDocument: (
  ...
  return postWithProgress(`${prefix}/${dataset_id}/document/table`, data, undefined, onProgress, loading)
}
